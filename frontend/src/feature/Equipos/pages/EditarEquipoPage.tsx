        ...
        <>
            ...
            <Container>
                <EquipoForm textoBoton="Editar Equipo"
                    ...
                    valoresIniciales={{ nombre: equipo.nombre, categoria: equipo.categoria, ubicacion: equipo.ubicacion, sector_id: equipo.sector?.id, plan_limpieza_id: equipo.plan_limpieza_id }}/>
            </Container>
        </>
    )
}